...
{
    //document.getElementById("test").innerText += num;
	//num++;
	
	if (show_weather)
	{
	    /*var weather_block_content = document.getElementById("weather_block_content");
		var new_weather_block_content = '<div class="block_content">';
		
		new_weather_block_content += '<p class="weather_location" id="weather_location">Seattle, WA</p>'
		new_weather_block_content += '<p><span id="date">Thursday, January 42, 7022</span></p>'
		new_weather_block_content += '<p><span id="time">3:43 PM</span></p>'
		
		new_weather_block_content += '<br>';
						
		new_weather_block_content += '<p class="weather_now_temp" id="weather_now_temp">62 F</p>';
		new_weather_block_content += '<p class="weather_now_state" id="weather_now_state">Cloudy</p>';
		new_weather_block_content += '<br>';
		
		new_weather_block_content += '<br><br>';
		new_weather_block_content += '<p class="section_title"><strong>Today</strong> <button onclick="javascript:ToggleWeatherTodayButton(this)">-</button></p>';
		new_weather_block_content += '<hr>';
		new_weather_block_content += '<div id="weather_today"></div>';
		new_weather_block_content += '<br><br>';
		new_weather_block_content += '<p class="section_title"><strong>Outlook</strong> <button onclick="javascript:ToggleWeatherOutlookButton(this)">-</button></p>';
		new_weather_block_content += '<hr>';
		new_weather_block_content += '<div id="weather_outlook"></div>';
		new_weather_block_content += '</div>';
		
		weather_block_content.innerHTML = new_weather_block_content;*/
	}
	else
	{
	    var weather_block_content = document.getElementById("weather_block_content");
	...
	// Update Time and Date
	{
		...
		var date_string = weekday + ", " + month + " " + date.getDay() + ", " + date.getYear();
